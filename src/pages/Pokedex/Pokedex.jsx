...
const Pokedex = () => {
  ...
  const fetchPokemon = async () => {
    try {
      ...
      setFetching(
        `Found ${pokemonName.slice(0, 1).toUpperCase() + pokemonName.slice(1)}`
      );
      ...
      <div className="container">
        <div className="pokemon-details">
          <h1 className="pokemon-name">
            <img width="25" height="25" src={location} />
        ...
        <div className="search-container">
          ...
          <button className="find-btn" onClick={fetchPokemon}>
            <img src={logo} />
          </button>
          <h1 className="status">
            <span>Status: </span> {fetching}
          </h1>
        </div>
      </div>
    </div>
